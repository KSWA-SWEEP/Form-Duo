                  ...
                  {/* <div className="hidden md:block">
                    <div className="flex items-center ml-4 md:ml-6">
                      <div className="items-center justify-end hidden md:flex md:flex-1 lg:w-0">
                        ...
                        >
                          <div className="text-sm font-normal text-gray-500 duration-200 whitespace-nowrap hover:text-fdbluedark hover:scale-105">
                            Sign In
                          </div>
                        </Link>
                        <Link
                  ...
                  <div className="hidden md:block">
                    <div className="flex items-center ml-4 md:ml-6">
                      ...
                      <Menu as="div" className="relative ml-3">
                        <div>
                          <Menu.Button className="flex items-center max-w-xs text-sm rounded-full bg-neutral-800 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2">
                              ...
                              <Menu.Item key={item.name}>
                                {({ active }) => (
                                  <a
                                    ...
                                    ) + ( item.name == "로그아웃" ? "text-red-600" : "text-gray-700")}
                                  >
                                    {item.name}
                                  </a>
                                )}
