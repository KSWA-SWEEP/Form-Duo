...
export default function SurveyPreview(props) {
    ...
    return (
        <div>
            ...
            />
            {/* 질문 목록 */}
            <ShowQuestionList svyContents={svyContents} svyRespContents={svyRespContents} setSvyRespContents={setSvyRespContents} isModify={props.isModify} isDuoResult={true}/>
